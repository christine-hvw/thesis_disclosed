...
Analyses conducted on regional <b> sample </b> of elementary schools.
</p>
...
### Spreading properties of single-layer and multi-layer networks differ - Preliminary results **support** that.

### Multi-layer centrality measures account for complex structure (De Domenico et al. 2015).
]
...
### 1. Simulate outbreak
### 2. Predict time point of infection with centrality measure
